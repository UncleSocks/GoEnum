# GoEnum
Web enumeration script using tools written in Go (plus NMap) for TCM Security's PEH course. This is an (updated) iteration of Gr1mmie's sumrecon without the non-Go-based tools (third-level subdomain and whatweb). This has been tested in Kali Linux and Ubuntu distros.
